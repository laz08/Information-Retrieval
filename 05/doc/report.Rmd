...
Let us defined $$TA_{min} = 0.15$$ as the minimum Term Appearance of each term in the whole corpus. This means that if a term appears in the whole corpus less than 15% respect to the total, then this word is not going to be taken into account and removed from our vocabulary.
...
kable(table[1:12, ])
ggplot(data = table) +
  aes(x = thresholds, y = numTerms, size = numTerms) +
